...
export const es = {
  ...
  pages: {
    ...
    estimation: {
      title: "¿Cómo valoras la intensidad del ruido mental en estos momentos?",
    },
    temporalOrientation: {
    ...
    microIntervention: {
      ...
      instructionByNotificationAnswer: {
        ...
        no: "Perfecto. Al hacer clic en el botón correspondiente empezará la pausa.",
    ...
    history: {
      ...
      progressTitle: "Evolución reciente",
      progressSummary: "La línea muestra cuánto cambió la intensidad en cada intento respecto al punto de partida.",
      scoreCardLabel: "Puntuación de tendencia reciente",
      scoreEyebrow: "Tendencia reciente",
      scoreOutOfLabel: "/ 100",
      scorePositiveLabel: "Tendencia positiva",
      scoreStableLabel: "Tendencia estable",
      scoreNeedsCareLabel: "Necesita más intentos",
      metricsLabel: "Resumen del progreso",
      totalAttemptsLabel: "intentos",
      improvedAttemptsLabel: "con menos intensidad",
      averageReductionLabel: "reducción media",
      chartAriaLabel: "Gráfico de cambio de intensidad por intento",
      chartCaption: "La línea central marca 0. Verde por debajo indica menos intensidad al final; rojo por encima indica más intensidad.",
